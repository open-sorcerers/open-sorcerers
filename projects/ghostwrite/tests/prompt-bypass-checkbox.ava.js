...
test('verify bad bypass input', function (t) {
	t.throws(() => promptBypass(prompts, ['one,four'], skeletal));
	t.throws(() => promptBypass(prompts, ['four'], skeletal));
	t.throws(() => promptBypass(prompts, ['3'], skeletal));
});
