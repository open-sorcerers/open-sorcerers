...
const basicAdd = skeletal.getGenerator('basic-add');
...
test('Test the content of the rendered file _THIS_IS_A_TEST.txt', t => {
	...
	t.true(content.includes('test: basic-bonefile-test'));
	t.true(content.includes('propertyPathTest: basic-bonefile-test-propertyPath-value-index-1'));
});
