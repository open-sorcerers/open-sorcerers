...
var cosmicConfigurate = curry$1(function (ligament, cancel, conf) {
  ...
  return pipe$1(
    function (z) { return z || {}; },
    ifElse(propOr(false, "configFile"), cosmicLoad, function () { return cosmicSearch(); }),
    map(pipe$1(propOr(identity, "config"), function (z) { return z(ligament); }))
  )(conf)
});
